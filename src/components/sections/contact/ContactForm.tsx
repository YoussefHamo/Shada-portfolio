...
const socialLinks = [
  {
    ...
    user: '@shadaa_ashraff',
    icon: FaInstagram,
    link: 'https://www.instagram.com/shadaa_ashraff?igsh=NXV1ZTJ4ODFmdGF3&utm_source=qr',
  },
  {
    title: 'TikTok',
    user: '@dodaashraf03',
    icon: FaTiktok,
    link: 'https://www.tiktok.com/@dodaashraf03?_r=1&_t=ZS-976ZuQyEUCX',
  },
  {
    title: 'WhatsApp',
    user: '+201276392235',
    icon: FaWhatsapp,
    link: 'https://wa.me/201276392235',
  },
]
