...
const skills = ["Space Planning", "AutoCAD", "3ds Max", "Photoshop", "Color Theory"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Modern Living Rooms", "Minimalist Kitchens", "Luxury Interiors"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Creative Interior Designer & 3D Visualizer specializing in
            transforming concepts into realistic, functional, and visually
            compelling spaces through high-quality 3D visualization and
