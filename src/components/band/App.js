...
export default function App() {
  ...
  return (
    ...
    >
      <Canvas
        gl={{ alpha: true, outputColorSpace: THREE.SRGBColorSpace, toneMapping: THREE.ACESFilmicToneMapping, toneMappingExposure: 1.0 }}
      ...
      >
        ...
        <directionalLight position={[2, 4, 3]} intensity={1.2} color="#fff8f0" />
        <directionalLight position={[-2, 3, 2]} intensity={0.6} color="#f0e8e0" />

        <Scene isMobile={isMobile} />

        <Environment blur={0.5} background={false}>
          <Lightformer
            intensity={0.8}
            color="#fff8f0"
            position={[0, 5, 0]}
...
function Band({ isMobile, maxSpeed = 50, minSpeed = 10 }) {
  ...
  const cardTexture = useTexture('/assets/card-image.png');
  cardTexture.colorSpace = THREE.SRGBColorSpace;
  cardTexture.flipY = false;
  cardTexture.wrapS = cardTexture.wrapT = THREE.ClampToEdgeWrapping;
  cardTexture.offset.set(0.28, 0);
  cardTexture.repeat.set(0.85, 1);
  ...
  const cardMaterial = materials.base.clone();
  cardMaterial.map = cardTexture;
  cardMaterial.roughnessMap = null;
  cardMaterial.metalnessMap = null;
  cardMaterial.normalMap = null;
  cardMaterial.aoMap = null;
  cardMaterial.roughness = 0.35;
  cardMaterial.metalness = 0;
  cardMaterial.clearcoat = 0.5;
  cardMaterial.clearcoatRoughness = 0.1;
        ...
        >
          ...
          >
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial {...cardMaterial} />
            </mesh>
